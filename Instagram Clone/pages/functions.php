  ...
  echo' <div class = "first">
    <div id="nav-bar">
      ...
      <div id="nav-content">
        ...
        <div class="nav-button" data-nav="Notifications"><i class="fas fa-images"></i><span>Notifications</span></div>
        <hr/>
        ...
        <hr/>
        <div class="nav-button" data-nav="Help"><i class="fas fa-magic"></i><span>Chatbot</span></div>
